...
module.exports = eval("require")("wakatime-client-remastered");
...
var fast_content_type_parse = __nccwpck_require__(862);
...
(__nccwpck_require__(987).config)();
const { WakaTimeClient, RANGE } = __nccwpck_require__(103);
const { Octokit } = __nccwpck_require__(137);
